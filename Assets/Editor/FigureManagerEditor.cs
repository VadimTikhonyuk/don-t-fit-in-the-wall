...
{
	static FigureContainer container;
	...
	void OnGUI()
	{
        container = (FigureContainer)EditorGUILayout.ObjectField (container, typeof(FigureContainer), true);
        if (container == null)
            return;

		GUILayout.BeginHorizontal ();
		if (GUILayout.Button ("Revert")) {
			figures = container.AllFigures;

		}
		if (GUILayout.Button ("Apply")) {
            container.AllFigures = figures;
		}
